...
{ 
  ...
  //
  //?
  G4double sphere_inner_radius = 65*cm;  //KamLAND: 650cm radius
  G4double sphere_outer_radius = 85*cm;
  ...
  */
  ...
  //std::string scintspec_file="data/KamLAND/scintspec2_KamLAND.txt"; //KamLAND
  //std::string scintspec_file="data/scintspec_Cytodiagnostics_17May_measurement.txt"; //alloyed QDs from Cytodiagnostics (450nm peak)
  std::string scintspec_file="data/scintspec_Cytodiagnostics_17May_measurement_shifted.txt"; //alloyed QDs from Cytodiagnostics (450nm peak) but shifted by 77nm to imitate 380nm peak
  ...
  //?
  //std::string QE_file="data/Digitization_R3809U-63.txt"; //QE of Hamamatsu R3809U-63 (Microchannel plate photomultiplier tube)
  std::string QE_file="data/QE_PMT_DC.txt"; //QE of DC PMT = QE of KamLAND 17" PMTs
