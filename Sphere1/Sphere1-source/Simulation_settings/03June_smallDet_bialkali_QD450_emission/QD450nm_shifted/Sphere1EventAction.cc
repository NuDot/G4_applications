...
{  
  ...
  G4cout << "----------------------The primary particle information: " << G4endl; 
  G4cout << "The PDG code is " << event->GetPrimaryVertex()->GetPrimary()->GetPDGcode() << G4endl;
  G4cout << "The mass is " << event->GetPrimaryVertex()->GetPrimary()->GetMass() << G4endl;
  G4cout << "The charge is " << event->GetPrimaryVertex()->GetPrimary()->GetCharge() << G4endl;
  //G4cout << "The momentum is " << event->GetPrimaryVertex()->GetPrimary()->GetMomentum() << G4endl;
  G4cout << "The momentum is (" << event->GetPrimaryVertex()->GetPrimary()->GetPx() << "," << event->GetPrimaryVertex()->GetPrimary()->GetPy() << "," <<event->GetPrimaryVertex()->GetPrimary()->GetPz() << ")." << G4endl;  
  G4cout << "The polarization is " << event->GetPrimaryVertex()->GetPrimary()->GetPolarization() << G4endl;
