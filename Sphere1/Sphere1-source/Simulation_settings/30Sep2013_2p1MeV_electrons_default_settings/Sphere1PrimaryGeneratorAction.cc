  ...
  fParticleGun(0)
{
  ...
  //?
  fParticleGun->SetParticleEnergy(2.1*MeV);
  ...
  //G4String hep_input_file = "/home/christoph/geant4/MyG4_applications/Sphere1-build/Generator/original/DBeta/output/hepevt_1_back_to_back.EVT"; //one back to back Cd116 0nuBB event
...
void Sphere1PrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
  ...
  */
  ...
  HEPEvt->SetParticlePosition(G4ThreeVector(0.*mm,0.*mm,0.*mm));
