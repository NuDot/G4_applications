...
#include "Sphere1PhysicsListMessenger.hh"
...
Sphere1PhysicsList::Sphere1PhysicsList() :  G4VUserPhysicsList()
{
  ...
  pMessenger = new Sphere1PhysicsListMessenger(this);  
  SetVerboseLevel(0);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

Sphere1PhysicsList::~Sphere1PhysicsList() { delete pMessenger;}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void Sphere1PhysicsList::ConstructParticle()
{
...
void Sphere1PhysicsList::ConstructBosons()
{
  // pseudo-particles
...
void Sphere1PhysicsList::ConstructLeptons()
{
  // leptons
  //  e+/-
...
void Sphere1PhysicsList::ConstructMesons()
{
  //  mesons
...
void Sphere1PhysicsList::ConstructBaryons()
{
  //  barions
...
void Sphere1PhysicsList::ConstructProcess()
{
  AddTransportation();
  ConstructGeneral();
  ConstructEM();
...
void Sphere1PhysicsList::ConstructGeneral()
{
  // Add Decay Process
...
void Sphere1PhysicsList::ConstructOp()
{
  ...
  */
  ...
  // switch on/off the scintillation rise time
  //?
...
void Sphere1PhysicsList::SetVerbose(G4int verbose)
{
...
void Sphere1PhysicsList::SetNbOfPhotonsCerenkov(G4int MaxNumber)
{  
  theCerenkovProcess->SetMaxNumPhotonsPerStep(MaxNumber);
}
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void Sphere1PhysicsList::SetCuts()
{
